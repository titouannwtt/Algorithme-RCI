...
csv="/home/moutonneux/bots/backtest/backtest-indicateur-1h/all_results.csv"
bestValuecsv="/home/moutonneux/bots/backtest/backtest-indicateur-1h/best_results.csv"
...
if bestValue<float(classement['finalBalance'].iloc[0]):
    ...
    print("Nouvelle meilleure performance pour l'algo multiples indicators en timeframe 1h!")
